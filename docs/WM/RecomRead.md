...
> 这里整理了一些我在学习 **WorldModel** 过程中值得反复看的中文资料

<div class="vla-read-list">
  <a class="vla-read-card" href="https://liyang.page/wm-tutorial/#8-%E4%BB%8E-world-model-%E5%88%B0-world-action-model" target="_blank" rel="noopener noreferrer">
    <div class="vla-read-body">
      ...
      <h3>WM的详细介绍</h3>
      <p>World Model：从强化学习到具身智能的完整入门。</p>
  ...
  <a class="vla-read-card" href="https://song2yu.github.io/world-model-vla/#wm" target="_blank" rel="noopener noreferrer">
    <div class="vla-read-body">
      <div class="vla-read-glow"></div>
      <div class="vla-read-head">
